...
const FinancialAssistance = () => {
  ...
  const handleApplyClick = () => {
    toast({
      ...
      description: "Your financial assistance application has been initiated.",
    });
  };
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="p-5 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <Button className="w-full" onClick={handleApplyClick}>Learn More & Apply</Button>
                  </div>
                  ...
                  <div className="p-5 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <Button className="w-full" onClick={handleApplyClick}>Set Up Payment Plan</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-800 font-medium flex-shrink-0">
                        1
                      </div>
                      <div>
                        ...
                        <Button size="sm">Start Step 1</Button>
                      </div>
                    </div>
                    
                    <div className="flex items-start gap-4">
                      <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 text-gray-800 font-medium flex-shrink-0">
                        2
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-500">Financial Information</h4>
                        <p className="text-gray-500 mb-2">
                          Income details, expenses, and financial obligations.
                        </p>
                        <Button size="sm" variant="outline" disabled>Complete Step 1 First</Button>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-500">Document Upload</h4>
                        <p className="text-gray-500 mb-2">
                          Upload required financial documentation.
                        </p>
                        <Button size="sm" variant="outline" disabled>Complete Step 2 First</Button>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-500">Review & Submit</h4>
                        <p className="text-gray-500 mb-2">
                          Review your application and submit for consideration.
                        </p>
                        <Button size="sm" variant="outline" disabled>Complete Previous Steps</Button>
                      </div>
                    </div>
                  </div>
                </div>
