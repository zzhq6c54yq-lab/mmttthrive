...
import { Briefcase, Building, BarChart, Calendar, CopyCheck, Lightbulb, Users, Heart, Shield, Money, HandHeart, Briefcase as BriefcaseIcon } from "lucide-react";
...
const SmallBusinessPortal: React.FC = () => {
  ...
  const handleEnterPortal = () => {
    ...
    // Navigate to the small business experience page
