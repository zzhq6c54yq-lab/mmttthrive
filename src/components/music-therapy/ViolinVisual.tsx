  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <div className="relative bg-gradient-to-br from-amber-200 via-amber-300 to-amber-400 rounded-full p-8 shadow-2xl">
        {/* F-holes */}
        <div className="absolute left-1/3 top-1/4 w-1 h-16 bg-gray-800 rounded-full transform -rotate-12"></div>
        <div className="absolute right-1/3 top-1/4 w-1 h-16 bg-gray-800 rounded-full transform rotate-12"></div>
