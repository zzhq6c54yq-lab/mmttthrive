  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto">
      ...
      <div className="relative bg-gradient-to-br from-orange-200 via-orange-300 to-orange-400 rounded-lg p-12 shadow-2xl" style={{ aspectRatio: '3/4' }}>
        {/* F-holes */}
        <div className="absolute left-1/3 top-1/3 w-2 h-20 bg-gray-800 rounded-full transform -rotate-12"></div>
        <div className="absolute right-1/3 top-1/3 w-2 h-20 bg-gray-800 rounded-full transform rotate-12"></div>
