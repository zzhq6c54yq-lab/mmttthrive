    ...
    <div className="w-full bg-gradient-to-r from-[#1c2e4a] to-[#2d3748] border-y border-[#B87333]/20 py-4 px-4 shadow-lg relative z-10 overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <Button 
            variant="gold"
            className="flex items-center justify-center px-4 py-2 rounded-lg transform transition-all duration-300 hover:scale-105 shadow-[0_4px_12px_rgba(0,0,0,0.25)] group col-span-full"
