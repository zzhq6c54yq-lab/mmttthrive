    ...
    <div className="w-full bg-gradient-to-r from-[#1c2e4a] to-[#2d3748] border-y border-[#B87333]/20 py-6 px-4 shadow-lg relative z-10 overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative">
        ...
        <div className="grid grid-cols-3 gap-6">
          <Button 
            variant="bronze"
            className="flex flex-col items-center justify-center p-6 rounded-xl transform transition-all duration-300 hover:scale-105 shadow-[0_4px_20px_rgba(0,0,0,0.3)] group backdrop-blur-sm"
            onClick={() => handleNavigation("/barter-system", "Barter System")}
          >
            <span className="text-base font-medium mb-1">Barter</span>
            <span className="text-base font-medium">System</span>
          </Button>
          
          <Button 
            variant="gold"
            className="flex flex-col items-center justify-center p-6 rounded-xl transform transition-all duration-300 hover:scale-105 shadow-[0_4px_20px_rgba(184,115,51,0.4)] group backdrop-blur-sm"
          ...
          >
            <span className="text-base font-medium mb-1">Co-Pay</span>
