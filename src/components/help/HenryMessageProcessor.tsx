  ...
  const handleSendMessage = (message: string) => {
    ...
    if (isEmergency && !emergencyMode) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          const counselorJoiningMessage = "Hello, I'm Dr. Sarah, a licensed therapist who's joining this conversation. I appreciate your courage in sharing these difficult feelings. I'd like to work with you directly now to ensure your safety and provide the support you need. Could you share a bit more about what's happening for you right now?";
