  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a2e] via-[#242452] to-[#1a1a2e] text-gray-700 pt-6 pb-20 px-4 relative overflow-hidden">
      <div className="absolute inset-0 z-0 overflow-hidden">
        {/* Deep purple/blue texture and gradient background */}
        ...
        {/* Top purple gradient */}
        <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-[#482880] to-transparent"></div>
        
        {/* Bottom purple gradient */}
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#482880] to-transparent"></div>
        
        {/* Middle deep purple area */}
        <div className="absolute top-32 bottom-32 left-0 right-0 bg-gradient-to-b from-[#242452]/90 via-[#2a2a5a] to-[#242452]/90"></div>
